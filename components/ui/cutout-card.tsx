...
export const cutoutCardSurfaceShadowClassName = cn(
  ...
  "shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.4),0px_4px_8px_-2px_rgba(0,0,0,0.3),0px_8px_16px_-4px_rgba(0,0,0,0.2)]",
  "transition-[box-shadow,border-color] duration-500 ease-[cubic-bezier(0.23,1,0.32,1)]",
  "hover:border-white/20 hover:shadow-[0px_2px_4px_-1px_rgba(0,0,0,0.5),0px_8px_16px_-4px_rgba(0,0,0,0.4),0px_16px_32px_-8px_rgba(0,0,0,0.3)]"
)

export const cutoutCardSurfaceClassName = cn(
  "group/cutout relative cursor-pointer overflow-hidden rounded-[28px] bg-[#1c1c1e] text-white",
...
export type CutoutCardImageProps = HTMLAttributes<HTMLImageElement> & {
  src: string
  alt?: string
  fill?: boolean
  sizes?: string
